...
Create MOFED Module.symvers file
...
There is probably another Lustre issue with redefintion of CONFIG_LNET_MAX_PAYLOAD variable that might be fixed by editing config.h file
